namespace PAEDUCA.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PAEDUCA.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(PAEDUCA.Models.ApplicationDbContext context)
        {

            var universidades = new List<Universidad>
            {
                new Universidad {Nombre ="Universidad Nacional de Ingeniería",Siglas="UNI",Logo = null, Eslogan = "Lider en Ciencia y Tecnología"},
            ...
            AspectosAAC[2].CriterioACC = new List<CriterioAAC>
            {
                new CriterioAAC
                {
                    Nombre = "Contribuye en la construcción del expediente de asignatura",
                    TipoValor = TipoValor.SiNo,
                    TipoVisualizacion = TipoVisualizacion.RadioButton
                },
                new CriterioAAC
                {
                    Nombre = "Asiste a reuniones metodológicas del DD",
                    TipoValor = TipoValor.SiNo,
                    TipoVisualizacion = TipoVisualizacion.RadioButton
                },
                new CriterioAAC
            ...
            AspectosAAC.ForEach(x=> context.AspectoAAC.Add(x));
            context.SaveChanges();
        }
    }
}
